...
놓치기 쉬운 흐름까지 설계로 해결하는 프론트엔드 개발자 한아름입니다.

### 🚀 Projects
- [요약의 정석: 요정](https://github.com/orgs/Fairy-s-Essentials/repositories) - Gemini AI 기반 요약 학습 플랫폼 
- [PICK-O](https://github.com/areumH/PICK-O-Client) - 밸런스 게임 투표 기반 소셜 플랫폼 
- [GJ NEWS](https://github.com/areumH/GJ-NEWS) - Google NLP 기반 긍정 뉴스 큐레이션 서비스 

### 📚 Education
- JECT IT 사이드 프로젝트 동아리 2기 / 메이커스 2팀
